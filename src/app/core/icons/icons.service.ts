...
export class IconsService
{
    ...
    constructor()
    {
        ...
        matIconRegistry.addSvgIconSetInNamespace('carbon', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/carbon.svg'));
        matIconRegistry.addSvgIconSetInNamespace('table_icons', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/table-icons.svg'));
    }
}
